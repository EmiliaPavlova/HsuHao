namespace RabitFury.Classes
{
    ...
    public class AllCollectables
    {
        public AllCollectables(Texture2D[] collectable)
        {
            ...
            //this.collectables.Add(new Collectable(new Vector2(0.9f, 0.465f), new Vector2(0.0335f, 0.05f), Color.White, collectable[0]));
            //this.collectables.Add(new Collectable(new Vector2(0.9f, 0.45f), new Vector2(0.0335f, 0.0335f), Color.White, collectable[1]));
        }
