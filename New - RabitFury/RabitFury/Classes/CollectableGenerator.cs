namespace RabitFury.Classes
{
    ...
    public class CollectableGenerator
    {
        public static List<Collectable> GenerateCollectable(Texture2D[] theTexture)
        {
            ...
            for (int i = 6, index = 1; i < 100; i += 2, index++)
            {
                collectables.Add(new Collectable(new Vector2(i * index * 0.1f, 0.35f), new Vector2(0.03f, 0.03f), Color.White, theTexture[2], 10));
                collectables.Add(new Collectable(new Vector2(i * index * 0.25f, 0.3f), new Vector2(0.03f, 0.03f), Color.White, theTexture[2], 15));
                collectables.Add(new Collectable(new Vector2(i * index * 0.2f, 0.2f), new Vector2(0.03f, 0.03f), Color.White, theTexture[2], 20));
